-- Torna calc_product_stock resiliente à ausência de public.stock_movements
-- Evita falha ao criar/usar a função quando tabela legacy não foi criada
...
comment on function public.calc_product_stock() is 'Estoque/reservado/disponível incluindo todos os produtos e ignorando legacy se tabela não existir.';
